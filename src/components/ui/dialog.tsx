...
// No data-closed:animate-out exit animation: Base UI keeps the popup mounted
// until that CSS animation reports completion, and CSS animations stall
// while the tab is backgrounded (phone locks, notification, app switch —
// reproduced: a dialog submitted right before backgrounding stayed fully
// opaque and interactive, blocking the whole page, even 5+s after
// returning). With no exit animation to wait for, close is instant instead.
